      ...
      <section className={styles.hero}>
        ...
        <div className={`container ${styles.heroContent}`}>
          <div className={styles.heroTag}>
            <span className="f1-tag">F1-Inspired Café</span>
          </div>
          <h1 className={styles.heroTitle}>
            <span className={styles.heroLine1}>Where Every Cup</span>
            <span className={styles.heroLine2}>Is a Winning Lap</span>
          </h1>
          <p className={styles.heroDesc}>
            Experience the ultimate blend of artisan coffee and Formula 1 passion 
            at Kuching&apos;s trendiest café. Aesthetic vibes, exotic flavors, racing spirit.
          </p>
      ...
      <section className={`section ${styles.featured}`}>
        <div className="container">
          ...
          <div className={styles.drinkGrid}>
            {[
              { name: "Matcha Latte", desc: "Signature matcha with perfectly steamed milk, consistently smooth every time.", rating: "4.8", price: "RM 14", icon: "🍵" },
              { name: "Houjicha Latte", desc: "Roasted Japanese green tea latte with a warm, toasty flavor profile.", rating: "4.6", price: "RM 14", icon: "🫖" },
              { name: "Espresso Shot", desc: "Bold, rich espresso — the fuel that powers your day like a turbo engine.", rating: "4.7", price: "RM 8", icon: "☕" },
              { name: "Iced Spanish Latte", desc: "Creamy condensed milk meets bold espresso over ice. Sweet victory in a glass.", rating: "4.9", price: "RM 15", icon: "🥤" },
            ].map((drink, i) => (
              <div key={i} className={styles.drinkCard}>
                <div className={styles.drinkIcon}>{drink.icon}</div>
                <div className={styles.drinkRating}>

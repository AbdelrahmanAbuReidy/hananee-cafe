      ...
      <div className={`container ${styles.footerGrid}`}>
        ...
        <div className={styles.brandCol}>
          <Link href="/" className={styles.footerLogo}>
            <Image src="/logo.jpg" alt="Hananee Cafe" width={50} height={50} />
            <div>
          ...
          <div className={styles.socialLinks}>
            <a href="https://www.instagram.com/hananeecafe/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className={styles.socialLink}>
            ...
            <a href="https://www.facebook.com/p/Hananee-61581697183774/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className={styles.socialLink}>
              <svg viewBox="0 0 24 24" width="20" height="20" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
            </a>
            <a href="https://wa.me/60109203889" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className={styles.socialLink}>
        ...
        <div className={styles.linkCol}>
          ...
          <div className={styles.f1Hours}>
            <span className={styles.f1Emoji}>🏎️</span>
            <em>Open 7 days — pit stops welcome!</em>
          </div>
        </div>
        ...
        <div className={styles.linkCol}>
          ...
          <div className={styles.contactInfo}>
            ...
            <p>📱 <a href="https://wa.me/60109203889">WhatsApp Us</a></p>
          </div>
        </div>
      </div>
